Meteor.methods({
	...
	getFBFriendData: function(limit){
		var fb = new Facebook(Meteor.user().services.facebook.accessToken);
		var data = fb.getFriendData(limit);
		return data;
	},
...
Facebook.prototype.getFriendData = function(limit) {
	// return this.query('me/friends/?offset=0');
	return this.query('me/friends/?limit=' + limit);
